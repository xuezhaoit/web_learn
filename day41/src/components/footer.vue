  ...
  <footer class="common-footer">
      <div class="sections">
        ...
        <section class="qr-section">
          <h3>36氪APP下载</h3>
          <img class="qr" alt="36氪APP下载" src="img/57rrbw8czufu0hqm.png">
          <div>
            iPhone &amp; Android
          </div>
        </section>
        ...
        <div class="container">
          ...
          <div class="copyright">
            <span class="mobile-hide">
              本站由
              <a href="#" rel="nofollow">
                <img alt="阿里云" style="height: 12px;vertical-align: middle;margin-right: -10px;margin-left: 10px;position: relative;top: -2px;" src="img/aliyunfooter.png">
              </a>
            </span>
            <span class="law">
